...
public class LaptopAndNoteBooksPage extends Utility {
    ...
    public void mouseHoverOnLaptopsAndDesktopTab() {
        ...
        mouseHoverOnLaptopsAndDesktopTab(laptopsAndDesktopTab);
    }

    private void mouseHoverOnLaptopsAndDesktopTab(WebElement laptopsAndDesktopTab) {
    }
 ...
 public void clickOnElement(WebElement showAllLaptopsAndNotebooksTab) {
   ...
   public  void selectByVisibleTextFromDropDown(WebElement sortByPriceHighToLow, String s) {
    ...
    public String GetSortByHighToLowOrder() {
        ...
        System.out.println(originalProductsPrice);
        selectByVisibleTextFromDropDown((WebElement) By.id("input-sort"), "Price (Low > High)");
